...
// r160 compatibility: ColladaLoader expects colorSpaceToWorking
if ( ColorManagement && ! ColorManagement.colorSpaceToWorking && ColorManagement.toWorkingColorSpace ) {
	ColorManagement.colorSpaceToWorking = ColorManagement.toWorkingColorSpace;
}
